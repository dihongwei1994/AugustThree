 ...
 * introduce:
 */
class SetView extends RelativeLayout {
    ...
    public void setListener(OnChangerListener listener) {
        ...
        LayoutInflater.from(this.mContext).inflate(R.layout.popup_set, this);
    }

    public SetView(Context context, TextView tv, RelativeLayout layout,XFloatView.OnDirectionLister lister) {
        super(context);
        this.tv = tv;
        this.mContext = context;
        this.lister = lister;
        RelativeLayout inflate = (RelativeLayout) LayoutInflater.from(context).inflate(R.layout.popup_set, null);
